...
st.markdown("This application is a Streamlit dashboard that can be used "
	"to analyze motor vehicle collision in NYC Search Results 💥🚗")
...
injured_people = st.slider("Number of persons injured in vehiclec collisions", 0, 19)
...
st.markdown("Vehilce collisions between %i:00 and %i:00" % (hour, (hour+1) % 24))
